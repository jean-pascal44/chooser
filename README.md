...
Petite **web app statique** (HTML, CSS, JavaScript) inspirée des applis type *finger chooser* : chacun pose un doigt sur l’écran, puis un participant est tiré au sort.
...
| `css/style.css` | Mise en forme et zone tactile             |
